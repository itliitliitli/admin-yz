    ...
    <a-layout-content>
      <div class="box_top">
        <a-breadcrumb>
          ...
          <a-breadcrumb-item>
            <!-- <a href="" @click="togoods"> 商品列表</a> -->
            <router-link :to="{ path: 'goods' }">商品列表</router-link>
          </a-breadcrumb-item>
          <a-breadcrumb-item>修改商品</a-breadcrumb-item>
        </a-breadcrumb>
        <h2 class="h2">修改商品</h2>
      </div>
      <div class="box_con">
        ...
        >
          <a-form-item
            ...
            :rules="[
              {
                required: formState.form.name ? false : true,
                message: '此项为必填项',
              },
            ]"
          >
          ...
          <a-form-item
            ...
            :rules="[
              {
                required: formState.form.subtitle ? false : true,
                message: '此项为必填项',
              },
            ]"
          >
          ...
          <a-form-item
            ...
            :rules="[
              {
                required: formState.form.detail ? false : true,
                message: '此项为必填项',
              },
            ]"
          >
          ...
          <a-form-item
            ...
            :rules="[
              {
                required: formState.form.price ? false : true,
                message: '此项为必填项',
              },
            ]"
          >
          ...
          <a-form-item
            ...
            :rules="[
              {
                required: formState.form.stock ? false : true,
                message: '此项为必填项',
              },
            ]"
          >
          ...
          <a-form-item
            ...
            :rules="[
              {
                required: formState.form.checked ? false : true,
                message: '此项为必填项',
              },
            ]"
          >
          ...
          <a-form-item
            ...
            :rules="[
              {
                required: formState.form.fileList ? false : true,
                message: '此项为必填项',
              },
            ]"
          >
...
export default defineComponent({
  ...
  setup() {
    ...
    const getformdata = async () => {
      const res = await http({
        url: "/api/manage/product/detail.do",
        method: "GET",
        params: {
      ...
      console.log(res);
      formState.form = res.data.data;
      console.log(formState.form);
      console.log(formState.form.detail);
      detail = res.data.data.detail;
      if (formState.form.status === 1) {
        checked.value = true;
      } else {
        checked.value = false;
      }
